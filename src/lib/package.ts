...
export const package_json = {
	...
	modules: {
		...
		'./intersect.js': {
			path: 'intersect.ts',
			declarations: [
				{name: 'IntersectCallback', kind: 'InterfaceDeclaration'},
				{name: 'IntersectParams', kind: 'InterfaceDeclaration'},
				{name: 'IntersectParamsOrCallback', kind: 'TypeAliasDeclaration'},
