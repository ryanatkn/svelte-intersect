...
export const package_json = {
	...
	modules: {
		...
		'./intersect.js': {
			path: 'intersect.ts',
			declarations: [
				{name: 'Intersect_Callback', kind: 'InterfaceDeclaration'},
				{name: 'Intersect_Params', kind: 'InterfaceDeclaration'},
				{name: 'Intersect_Params_Or_Callback', kind: 'TypeAliasDeclaration'},
				{name: 'intersect', kind: 'VariableDeclaration'},
			],
		},
